...
class TestScreenshotter(unittest.TestCase):
  def test_take_screenshot(self):
    img_format = 'png'
    screenshotter = Screenshotter(format=img_format, output_dir='test_images')
  ...
  def test_take_screenshot_with_invalid_url(self):
    screenshotter = Screenshotter(output_dir='test_images')
    url = 'invalid_url'
    filename = 'invalid'
  ...
  def test_take_screenshot_with_fullscreen(self):
    img_format = 'png'
    screenshotter = Screenshotter(fullscreen=True, format=img_format, output_dir='test_images')
    url = 'https://www.google.com'
  ...
  def test_take_screenshot_with_close_popups(self):
    img_format = 'png'
    screenshotter = Screenshotter(close_popups=True, format=img_format, output_dir='test_images')
    url = 'https://www.google.com'
  ...
  def test_take_screenshot_with_scroll_page(self):
    img_format = 'png'
    screenshotter = Screenshotter(scroll_page=True, format=img_format, output_dir='test_images')
    url = 'https://www.google.com'
